...
/*   Updated: 2021/09/24 13:43:11 by roms             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_subprintf(const char *s, va_list *list)
{
	...
	if (print.format != 'c' && print.format != 's' && print.format != 'd'
		&& print.format != 'i' && print.format != 'u' && print.format != '%'
		&& print.format != 'p' && print.format != 'x' && print.format != 'X')
		return (0);
